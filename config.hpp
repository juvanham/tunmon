...
namespace tunmon::cfg {
  ...
  class config {
    ...
    std::list<std::string> restore_dev_actions;
    std::list<std::string> post_restore_anydev_actions;
  ...
  public:
    ...
    std::list<std::string> get_restore_dev_actions() const;
    std::list<std::string> get_post_restore_anydev_actions() const;
